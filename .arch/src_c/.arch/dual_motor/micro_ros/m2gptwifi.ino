// #define MICROROS_SERIAL_BUFFER_SIZE 8192
#include <Arduino.h>
...
//const char* ssid = "U+NetEFDA";         // Replace with your WiFi SSID
//const char* password = "5D2A1A9EM#"; // Replace with your WiFi password
//const char* agent_ip = "192.168.1.100"; // Replace with your Jetson Nano’s IP
...
// std_msgs__msg__Int16 left_rpm_msg;
// std_msgs__msg__Int16 right_rpm_msg;
// rc = rclc_publisher_init_default(&left_rpm_pub, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Int16), "left_motor_rpm");
// #include <Arduino.h>
// #include <micro_ros_arduino.h>
// #include <rcl/rcl.h>
// #include <rcl/error_handling.h>
...
void timer_callback(rcl_timer_t *timer, int64_t last_call_time) {
  ...
  //left_rpm_msg.data = (int16_t)left_rpm;
  //right_rpm_msg.data = (int16_t)right_rpm;
